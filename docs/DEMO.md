...
verifier-accepted, shifted geomean 1.59 s.

```bash
python -m bench.comparator
```
Head-to-head with HiGHS. Agrees 11/11 to 3.7e-16.
...
roughly 33× slower on the LP set. The gap is presolve and a Forrest–Tomlin basis
